...
**Problem Statement:**
This is a reference section for common bit manipulation identities and tricks used in algorithms. There is no specific problem to solve, but these patterns are applied to optimize operations like counting set bits, isolating bits, and toggling states.

<strong class="example">Example 1:</strong>
```text
**Input:** x = 12 (1100 in binary)
**Output:** x & (x - 1) = 8 (1000 in binary)
**Explanation:** The lowest set bit is cleared.
```
</details>
...
**Input:** a = 1, b = 2
**Output:** 3
**Explanation:** The sum of 1 and 2 is 3, computed using bitwise operations.
```
</details>
...
**Problem Statement:**
Given an integer array `nums` of unique elements, return all possible subsets (the power set). The solution must not contain duplicate subsets. Return the solution in any order. This implementation specifically uses a bitmask approach.

<strong class="example">Example 1:</strong>
```text
**Input:** nums = [1,2,3]
**Output:** [[],[1],[2],[1,2],[3],[1,3],[2,3],[1,2,3]]
**Explanation:** All 8 possible subsets are generated by counting from 0 to 2^3 - 1 in binary.
```
</details>
...
**Output:** 1024.00000
**Explanation:** Calculates 2 to the power of 10.
```
</details>
...
**Problem Statement:**
Given a non-negative integer `x`, compute and return the square root of `x`. Since the return type is an integer, the decimal digits are truncated, and only the integer part of the result is returned. You must not use any built-in exponent function or operator.
...
**Problem Statement:**
Compute the Greatest Common Divisor (GCD) and Least Common Multiple (LCM) of two integers using the Euclidean algorithm. This is a common utility pattern used in broader number theory or math problems.

<strong class="example">Example 1:</strong>
```text
**Input:** a = 12, b = 18
**Output:** GCD = 6, LCM = 36
**Explanation:** The greatest common divisor of 12 and 18 is 6. Their least common multiple is 36.
```
</details>
...
**Input:** x = 123
**Output:** 321
**Explanation:** The digits are reversed properly without overflowing.
```
</details>
