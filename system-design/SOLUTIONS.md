...
4. **Map back to theory.** Each problem links (in [PROBLEM-BANK.md](PROBLEM-BANK.md)) to the relevant [HLD curriculum](../HLD/README.md) chapter — go deep there when a building block feels shaky.
